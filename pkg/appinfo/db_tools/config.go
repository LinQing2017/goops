...
func AddDBFlag(flags *pflag.FlagSet) {
	...
	flags.StringVar(&PortalMongoUrl, "mongo-database", os.Getenv("PORTAL_MONGODB_DATABASE"), "Mongodb 数据库名称。")
	flags.StringVar(&PortalMongoDB, "mongo-url", os.Getenv("PORTAL_MONGODB_URL"), "Mongodb 地址。")
}
